...
Initially, the list will be quite simple: 
we will only write three people to it using the data shown in the table below. 
In the rest of the course, you will return to this script and systematically 
...
let contact1 = "Maxwell Wright";
let contact2 = "Raja Villarreal";
let contact3 = "Helen Richards";
...
console.log(contact1 + " / " + phone1 + " / " + email1);
console.log(contact2 + " / " + phone2 + " / " + email2);
console.log(contact3 + " / " + phone3 + " / " + email3);
